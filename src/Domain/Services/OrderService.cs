...
public static class OrderService 
{
    ...
    {
        var o = new Order { Id = new Random().Next(1, 9999999), CustomerName = customer, ProductName = product, Quantity = qty, UnitPrice = price }; // Crea el objeto Order y le asigna un ID aleatorio.
        LastOrders.Add(o); 
